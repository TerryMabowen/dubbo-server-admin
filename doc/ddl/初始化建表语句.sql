...
(
    ...
    `creator`       varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作人姓名',
    `updated_time`  datetime                        NOT NULL,
    `updator_id`    bigint(20)                      DEFAULT NULL COMMENT '最后操作人id',
    `updator`       varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最后操作人姓名',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
